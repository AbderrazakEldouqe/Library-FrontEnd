...
@NgModule({
  declarations: [ContainerReservationsComponent, ListReservationsComponent, ListReservationsAllComponent, ListReservationsRetardRetourComponent, HeaderReservationsComponent],
  imports: [
    CommonModule,
